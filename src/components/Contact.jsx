...
const Contact = () => {
  return (
    <div className="flex flex-col items-center justify-top h-96 mt-5" id="contact">
        <h1 className="align-top flex justify-center font-poppins font-semibold text-6xl mb-5 colortext titlenamerobal cursor-default">Contato</h1>
        <p className="mb-5">Entre em contato comigo através do Linkedin ou e-mail vou responder assim que possivel.</p>
